...
local Response_mod_event_featurevent_review_list_s2c = class("Response_mod_event_featurevent_review_list_s2c", Response_Base)
local mod_event_featurevent_review_list_s2c_Data = import("app.Net.proto.data.mod_event_featurevent_review_list_s2c_Data")
function Response_mod_event_featurevent_review_list_s2c:ctor()

end
--复写父类的decode方法
function  Response_mod_event_featurevent_review_list_s2c:decode(data)
    self.super.decode(data);
    self.info = {}
    local _len = 0
    local len_mod_event_revieweventlist_s2c_list = data:readUShort()
    self.info._event_list = {}
    for i1 = 1, len_mod_event_revieweventlist_s2c_list do
    ...
    local len_mod_event_revieweventlist_s2c_event_conditions = data:readUShort()
    self.info._event_list[i1]["_conditions"] = {}
    for i2 = 1, len_mod_event_revieweventlist_s2c_event_conditions do
    ...
    local len_mod_event_revieweventlist_s2c_event_award = data:readUShort()
    self.info._event_list[i1]["_award"] = {}
    for i2 = 1, len_mod_event_revieweventlist_s2c_event_award do
    ...
    local len_mod_event_revieweventlist_s2c_event_award1 = data:readUShort()
    self.info._event_list[i1]["_award1"] = {}
    for i2 = 1, len_mod_event_revieweventlist_s2c_event_award1 do
    ...
    if nil == dataMap["mod_event_featurevent_review_list_s2c_Data"] then
        dataMap["mod_event_featurevent_review_list_s2c_Data"] = mod_event_featurevent_review_list_s2c_Data:create()
    end
    dataMap["mod_event_featurevent_review_list_s2c_Data"]:serialize(self.info)
end

return Response_mod_event_featurevent_review_list_s2c;