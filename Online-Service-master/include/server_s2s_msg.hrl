...
-define(M_SERVER_REGISTER_SERVICE, 3:16).        %% service注册到协议中转层
-define(M_SERVER_GC_REGISTER_TO_TPC, 4:16).      %% gc网关连接后 在tpc上注册
...
-define(M_SERVER_BROAD_ALL_MSG, 14:16).          %% 世界广播
-define(M_SERVER_RETURN_CAMPID_MSG,15:16).       %% 返回给gc网关用户阵营消息
%%%%%%% 服务器之间协议定义 end
